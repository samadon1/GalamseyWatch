...
Output (on the galamsey volume):
  /galamsey/data/unified_v4_multitask/
      galamsey_unified_v4_multitask_train.jsonl
...
app = modal.App("galamsey-build-unified-v4-multitask")
...
def build() -> dict:
    ...
    out_dir = root / "data/unified_v4_multitask"
    out_jsonl = out_dir / "galamsey_unified_v4_multitask_train.jsonl"
